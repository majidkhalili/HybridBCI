function [tempFeature] = eeg_Online_ExtractFeatures_Range_Mean(Data, fs, passbandInterval)
% EEG_ONLINE_EXTRACTFEATURES_RANGE_MEAN Calculates the mean value of the range EEG.
% INPUTS:
...
tempFeature = nanmean(rangeSignal);
