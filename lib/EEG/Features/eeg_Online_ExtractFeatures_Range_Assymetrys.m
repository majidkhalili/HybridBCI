function [tempFeature] = eeg_Online_ExtractFeatures_Range_Assymetrys(Data, fs, passbandInterval)
% EEG_ONLINE_EXTRACTFEATURES_RANGE_ASSYMETRYS Calculates a measure the symmetry of the rEEG
% INPUTS:
...
temp1 = nanmedian(rangeSignal) - prctile(rangeSignal,5);
temp2 = prctile(rangeSignal,95) - nanmedian(rangeSignal);
if isnan(rangeSignal)
    tempFeature = NaN;
else
    tempFeature = (temp2-temp1)/(temp1+temp2);
end
